...
from _2023.nuclear_decay_pt1 import video_intro
from _2023.nuclear_decay_pt1 import q_values
from _2023.nuclear_decay_pt1 import decay
from _2023.nuclear_decay_pt1 import video_outro

OUTPUT_DIRECTORY = r"C:\Users\isaac\Documents\TheFastNeutron\videos\2_nuclear_decay_pt1\scenes"
SCENES_IN_ORDER = [
    # ("video_intro", "TitleCard"),
    # ("video_intro", "TableOfContents"),
    # ("q_values", "QValuesTitleCard"),
    ("q_values", "QValues"),
    # ("decay", "DecayTitleCard"),
    # ("decay", "DecayAnimation"),
    # ("decay", "AlphaDecayAnimation"),
    # ("decay", "BetaDecayAnimation"),
    # ("decay", "GammaDecayAnimation"),
    # ("decay", "ChartOfNuclides"),
